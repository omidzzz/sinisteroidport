...
export default function ImageBlock({
  ...
  return (
    <figure className="group my-10">
      <div className="border border-line bg-panel p-1.5 transition-all duration-300 group-hover:border-accent/40 group-hover:shadow-[0_0_30px_rgba(var(--rgb-accent),0.07)]">
