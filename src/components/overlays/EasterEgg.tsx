...
export default function EasterEgg({
  ...
  return (
    <div
      className="term-veil fixed inset-0 z-[90] flex flex-col overflow-hidden bg-[#16161b] text-[#ff5a36]"
      role="dialog"
      aria-modal="true"
    ...
    >
      ...
      {/* close */}
      <div className="flex items-center justify-between border-b border-[#ff5a36]/25 px-5 py-3 font-mono text-[0.65rem] uppercase tracking-[0.25em] text-[#ff5a36]/80">
      ...
      >
        ...
        <div className="mb-6 inline-block">
          ...
          />
          <p className="mt-3 font-mono text-[0.65rem] uppercase tracking-[0.25em] text-[#ff5a36]/60">
        ...
        <div className="font-mono text-sm leading-relaxed">
          {boot.slice(0, revealed).map((line, i) => (
            <p key={i} className="text-[#ff5a36]/85">
              {line.href ? (
                <a
                  href={line.href}
                  target="_blank"
        ...
        >
          <input
            ...
            className="w-full bg-transparent font-mono text-sm text-[#ff5a36] caret-[#ff5a36] focus:outline-none"
      ...
      {/* footer status */}
      <div className="flex flex-wrap items-center justify-between gap-2 border-t border-[#ff5a36]/25 px-5 py-3 font-mono text-[0.62rem] uppercase tracking-[0.22em] text-[#ff5a36]/60">
