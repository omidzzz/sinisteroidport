...
const JOBS = {
  ...
  fa: [
    ...
    { period: "۲۰۲۲ — ۲۰۲۴", company: "آزاد", role: "مترجم و توسعه‌دهنده فرریلنسر", points: ["توسعه فرانت‌اند", "ترجمه ان↔فا", "استراتژی محتوا و سئو"] },
    { period: "۲۰۱۷ — ۲۰۲۲", company: "کافه هیچ", role: "باریستا و سرشیفت", points: ["مدیریت عملیات روزانه", "هماهنگی تیم", "خدمات مشتریان"] },
    { period: "۲۰۱۲ — ۲۰۱۷", company: "آزاد", role: "مترجم فرریلنسر", points: ["ترجمه انگلیسی ↔ فارسی", "پایه‌گذاری خدمات زبان"] },
  ],
} as const;
